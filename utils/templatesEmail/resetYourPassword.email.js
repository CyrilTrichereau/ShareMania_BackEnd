...
module.exports = {
  email: ({ emailToSend: email, token: token }) => {
    return {
      ...
      subject: "Réinitialisation de mot de passe - ShareMania.fr",
      text: "ShareMania.fr - Vous recevez ce mail afin de vous permettre de réinitialiser le mot de passe de votre profil. Si vous n'êtes pas à l'origine de ce message, contactez votre manager.",
      ...
      <html lang="fr">
        <head>
          ...
          <title>Réinitialisation de mot de passe - ShareMania.fr</title>
    <meta
      name="Réinitialisation de mot de passe - ShareMania.fr"
      content="Réinitialisation de mot de passe - ShareMania.fr"
    />
        </head>
        <!--     BODY     -->
